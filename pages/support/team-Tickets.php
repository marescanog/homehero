...
// disable page since we will not have this feature so we can finish project on time
header("Location: ../support/home.php");

// // ONLY SUPERVISORS HAVE ACCESS TO THIS PAGE
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <a onClick="addURLParameter(['tab','page'],['1','1'])" class="nav-item nav-link <?php echo $current_tab==1?"active":"";?>" id="nav-ongoing-tab" data-toggle="tab" href="#nav-ongoing" role="tab" aria-controls="nav-ongoing" aria-selected="<?php echo $current_tab==1?"true":"false";?>">Ongoing</a>
...
*/
                // $tableName = "New";
                // $basicSearchId = "newSearch";

                // $totalRecords = $new_total;
                // $tableRows = array_map('convertPlainDataToTableRow', $new_tickets);
        ...
        <div class="tab-pane fade <?php echo $current_tab==1?"show active":"";?>" id="nav-ongoing" role="tabpanel" aria-labelledby="nav-ongoing-tab">
            <?php 
                // $tableName = "Ongoing";
...
<!-- Custom JS Scripts Below -->
    ...
    //  }
?>
<script src="../../js/pages/all-tickets.js"></script> 
</body>
</html>