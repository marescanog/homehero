...
<div class="modal-content">
    ...
    ?>
    <div class="modal-header">
        <h5 class="modal-title" id="signUpModalLabel">CHANGE JOB END DATE & TIME</h5>
        <button type="button" class="close btn" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true" style="font-size:1.5em">&times;</span>
        </button>
    </div>
    <div name="modalForm">
    <form id="modal-edit-jo-end-date"  method="POST">
...
<script src="../../js/components/modal-validation/modal-sup-edit-jo-end-date.js"></script>
